...
public class Collection2 {
	...
	public static void main(String[] args) {
		List<Object> al = new ArrayList<Object>(16);
		int[] arr = {3, 5, 7, 9, 1};
...
//			System.out.println(element);
		...
		System.out.println(new ArrayList<Object>(al.subList(4, 9)));
		...
		printList(new ArrayList<Object>(hs));
	...
	public static void printList(List<Object> al) {
